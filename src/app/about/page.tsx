  ...
  return (
    <div className="w-full px-5 py-8 sm:px-8 sm:py-12 bg-gradient-to-br from-paper to-ink-50 dark:from-ink-900 dark:to-ink-800">
      <div className="mx-auto max-w-content">
        ...
        {/* Description */}
        <section className="mb-12 sm:mb-16 border-l-4 border-blue-500 dark:border-blue-400 bg-blue-50 dark:bg-blue-950 px-4 py-2 rounded">
        ...
        {/* Mission */}
        <section className="mb-12 sm:mb-16 border-l-4 border-green-500 dark:border-green-400 bg-green-50 dark:bg-green-950 px-4 py-2 rounded">
